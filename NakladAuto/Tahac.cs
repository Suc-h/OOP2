namespace NakladAuto
{
    internal class Tahac : NakladniAuto
    {
        ...
        public override void NalozNaklad(int hmotnost)
        {
            ...
            if (hmotnost+hmotnostNakladu > nosnost)
            {
                
                


                MessageBox.Show("Náklad nebyl naložen celý, protože hmotnost je větší než nosnost! Nenaložilo se proto: " + (hmotnost+hmotnostNakladu - nosnost + "T"));
